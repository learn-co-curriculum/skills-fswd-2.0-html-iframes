...
At some point in your journey, you will more than likely use code from a
different website. This can be for anything from displaying a Google search
bar, to a Youtube video, to more complicated things like a Google Map that
displays your users exact location. This is achieved by using HTML iframes. 
